...
#9. Ftech each product line and add a column to those product line showing "Good", "Bad".Good if its greater than average sales.

ALTER TABLE sales
ADD COLUMN product_line_type VARCHAR(15) NOT NULL;
...
SELECT customer_type, COUNT(*) AS cstm
FROM sales
GROUP BY customer_type
ORDER BY cstm DESC;
